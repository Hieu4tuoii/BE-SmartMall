...
public interface UserMapper {
    ...
    //update user by employee request
    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    User updateUser(EmployeeRequest request, @MappingTarget User user);

    // update thông tin tài khoản khách hàng hiện tại
    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)
    User updateCustomer(CustomerUpdateRequest request, @MappingTarget User user);
}
